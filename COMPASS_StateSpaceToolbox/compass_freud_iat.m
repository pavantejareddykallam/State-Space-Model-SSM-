...
%  create model
Param = compass_create_state_space(3,0,3,0,eye(3,3),[1 2 3],[0 1 1],[],[]);
% set learning parameters
Iter  = 100;
Param = compass_set_learning_param(Param,Iter,0,1,1,1,1,0,1,2,0);

% set threshold
Param = compass_set_censor_threshold_proc_mode(Param,log(1500),1,1);
...
[XSmt,SSmt,Param,XPos,SPos,ML,Yp]=compass_em([1 0],[],In,[],Yk,[],Param,valid);
